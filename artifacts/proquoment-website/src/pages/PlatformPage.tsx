    ...
    <main className="pt-20 lg:pt-32">
      ...
      <section className="relative px-6 lg:px-12 py-12 lg:py-20 max-w-[1440px] mx-auto overflow-hidden">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-12 relative z-10">
          <div className="lg:col-span-6 flex flex-col justify-center text-center lg:text-left">
            ...
            <p className="text-lg lg:text-xl text-slate-500 max-w-lg lg:max-w-none mb-8 lg:mb-10 leading-relaxed mx-auto lg:mx-0">
      ...
      <section className="bg-[#eeeeee] py-16 lg:py-32 px-6 lg:px-12">
        <div className="max-w-[1440px] mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
                  ...
                  <div className="bg-white border border-[#eeeeee] p-4 lg:p-6 rounded-2xl rounded-tl-none shadow-sm flex flex-col gap-4 w-full">
                    ...
                    <div className="flex flex-col gap-2">
                      {['Basic polyester fill', 'Synthetic Down', 'Technical Insulation'].map((opt) => (
                        <div key={opt} className="flex items-center gap-3 p-3 rounded-lg border border-[#c6c4d9] hover:border-[#070099] hover:bg-blue-50 cursor-pointer transition-colors group">
          ...
          <div className="lg:col-span-6 order-1 lg:order-2">
            ...
            <p className="text-base lg:text-lg text-slate-500 mb-8 lg:mb-10 leading-relaxed">
      ...
      <section className="py-16 lg:py-32 px-6 lg:px-12 bg-white">
        <div className="max-w-[1440px] mx-auto">
          <div className="text-center mb-12 lg:mb-20">
            ...
            <p className="text-sm lg:text-base text-slate-500">Vetted manufacturers competing for your project.</p>
          </div>
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
            <div className="lg:col-span-4">
              <div className="bg-[#f9f9f9] p-6 lg:p-8 rounded-[10px] h-full">
                ...
                <div className="flex items-center gap-2 px-3 py-1 bg-blue-50 text-[#070099] rounded-full w-fit">
            ...
            <div className="lg:col-span-8">
              <div className="space-y-4">
                {[
                  { name: 'Angela, Industrial Textiles', location: 'Surat • 98% Rating', price: '$42.50', tag: 'Per Unit', highlight: false,
                    img: 'https://lh3.googleusercontent.com/aida-public/AB6AXuAe6Cr17-1dPoA__NCdgxJ6On1sEhq3GqSVITwUFh6ZP4eQ0Bcpij7pkIWzvUS4cTdB4NKoD0u0zweV0o6_JeOU1iD-ynP34OuS9EyJlf594oWW9m72Kr0AhsoCVytuUbr1fxI7EcrE_7Xh1Xp1ynwbS9KfB4PJvwQn9u5W42joDk-f1ohATEBGAkgD15jw5z3C2P4Kt-hyBgKc9QvOGibB7U-ky3lEDTYVcBcJ6JfIZbQ7Oon3TTbwjrS4nPDG6x566mQC5AVzAEvp' },
                  { name: 'Frank, Master Weavers', location: 'Jaipur • 99% Rating', price: '$38.90', tag: 'Heavyweight Canvas', highlight: true, bestValue: true,
                    img: 'https://lh3.googleusercontent.com/aida-public/AB6AXuAJ3pAyFOPnfhpvvymHbLJQH3hxi6LhmTRDcCR2CFdq7ulVJt3yjZhUsPJxkrQVVCDfpbRRTZolyj3WEKdvfcWJKHL23rxPZCw-08QkRwneeceB-AZ8THpdQhMJRJ18TFUnrxdNqgN0xpXLMG1pRVsMYXvptzQo3JRpJbPomYLzikQVmsgaZ0PMFgULh4Y70fCrrIVKQdkNvjM4t5n3hA31o8RgojAN7_y6Fp0VhFC6P4GRwhVMVy4yBBYKAjAhT0riP3-YEhtHNpTX' },
                  { name: 'Jason, Global Logistics', location: 'Nasik • 95% Rating', price: '$41.00', tag: 'Per Unit', highlight: false,
                    img: 'https://lh3.googleusercontent.com/aida-public/AB6AXuCBD-70Jsx7uR0X4GONPXBle8JRpGGFMRt3lcN83oQxyBdlqlbWxrK7NzZTOBiSjVqM9xtfKiYdHlB3pFrDhITJHCetW2hPCofmpRQdCyj62rQtYcxTImUpzUzccpcj7vMihXCc3zL2sXsH770wdFXuGKBe06KS8Ohqtio8OvwW3GZy3S8U4f86uDvxYZxI8Dv5DeAOq-AK1u2K7u7pfBMX-f__k2J21vT5DevBLX7ouPTBaDmCUCMydp3ayITyV45hyPunvs6nI-Ic' },
                ].map((q: any) => (
                  <div key={q.name} className={`p-5 lg:p-6 rounded-[10px] flex items-center justify-between relative ${q.highlight ? 'bg-blue-50 border-2 border-[#070099]' : 'bg-white border border-[#eeeeee]'} ${q.highlight ? '' : 'hover:shadow-lg transition-shadow'}`}>
                    {q.bestValue && (
                    ...
                    <div className="flex items-center gap-4 lg:gap-6">
                      <div className="w-10 lg:w-12 h-10 lg:h-12 rounded-full bg-[#e8e8e8] overflow-hidden">
                        <img className="w-full h-full object-cover grayscale" src={q.img} alt={q.name} />
                      </div>
                      <div>
                        <h4 className="font-bold text-sm lg:text-base leading-tight">{q.name}</h4>
                        <p className="text-[10px] lg:text-xs text-[#767588]">{q.location}</p>
                      </div>
                    </div>
                    <div className="text-right flex flex-col items-end gap-1 lg:gap-2">
                      <span className="text-xl lg:text-2xl font-black text-[#070099]">{q.price}</span>
                      <span className={`text-[8px] lg:text-[10px] uppercase font-bold tracking-widest px-2 py-0.5 lg:py-1 rounded ${q.highlight ? 'bg-[#070099] text-white' : 'bg-[#eeeeee] text-[#1a1c1c]'}`}>{q.tag}</span>
                    </div>
                  </div>
                ))}
              </div>
      ...
      <section className="py-16 lg:py-32 px-6 lg:px-12 bg-[#f9f9f9]">
        <div className="max-w-[1440px] mx-auto flex flex-col items-center">
          <div className="max-w-3xl text-center mb-12 lg:mb-24">
            ...
            <p className="text-sm lg:text-lg text-slate-500 leading-relaxed">We don't just find the supplier. We oversee the entire production cycle with our boots-on-the-ground inspection network.</p>
          </div>
          <div className="w-full grid grid-cols-1 md:grid-cols-4 gap-8 lg:gap-12">
            {[
      ...
      <section className="py-16 lg:py-32 px-6 lg:px-12">
        <div className="max-w-[1440px] mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 items-center">
          <div className="lg:col-span-6">
            <h2 className="text-3xl lg:text-4xl font-black tracking-tighter mb-6 lg:mb-8 leading-tight">Order samples, pick a supplier,<br />get better pricing</h2>
            <p className="text-base lg:text-lg text-slate-500 mb-10 lg:mb-12 leading-relaxed">No more guessing games. Order physical prototypes from multiple factories to verify weight, texture, and construction before committing to scale.</p>
          ...
          <div className="lg:col-span-6">
            <div className="bg-white p-6 lg:p-10 rounded-[10px] shadow-[0px_40px_80px_rgba(15,0,218,0.08)] border border-[#eeeeee]">
              <div className="flex flex-col lg:flex-row justify-between items-start mb-8 lg:mb-10 gap-2">
                <div>
      ...
      <section className="py-16 lg:py-32 px-6 lg:px-12 bg-[#070099] overflow-hidden relative">
        <div className="absolute inset-0 halftone-bg" style={{ opacity: 0.1 }}></div>
        <div className="max-w-[1440px] mx-auto text-center relative z-10">
          <span className="text-[#a0a4ff] font-black tracking-[0.2em] uppercase text-[10px] lg:text-sm mb-6 lg:mb-8 block">Limited Access</span>
          ...
          <div className="flex flex-col md:flex-row justify-center items-center gap-3 lg:gap-4 max-w-sm lg:max-w-xl mx-auto">
            <input
              className="w-full bg-white text-[#1a1c1c] px-6 lg:px-8 py-4 lg:py-5 rounded-full text-sm lg:text-base font-medium focus:ring-4 focus:ring-[#0f00da] border-none outline-none"
